  ...
  <div className="grid grid-cols-2 justify-center pl-[200px]  md:grid md:grid-cols-1 lg:grid-cols-2 sm:grid sm:grid-cols-1">
    <div className=" ">
     ...
     <div className="flex items-center p-2 justify-center content-center  ">
      <div style={{ backgroundImage: `url(${emptyimg})` }} className="w-[561px]  h-[305px] justify-items-end px-0 pt-[140px] pl-[470px] lg:pl-[470px] md:pl-[380px]">
        <a className="grid grid-cols-1 lg:mx-40 xl:mx-20 gap-16 mx-3 relative justify-items-end   bg-[emptyimg]  pb-[20px] " href="/signup" >
        <AiOutlineShareAlt className="text-[#4699C2] text-2xl  " /></a>
        <a className="grid grid-cols-1 lg:mx-40 xl:mx-20  mx-3 relative justify-items-end   pb-[20px] " href="signup" >
        <ImFacebook className="text-[#4699C2] text-2xl " /></a>
        <a className="grid grid-cols-1 lg:mx-40 xl:mx-20 gap-16 mx-3 relative justify-items-end   pb-[20px]  " href="signup" >
        <FaInstagram className="text-[#4699C2] text-2xl  " /></a>
        <a className="grid grid-cols-1 lg:mx-40 xl:mx-20 gap-16 mx-3 relative justify-items-end   bg-[emptyimg] " href="signup" >
        <ImTwitter className="text-[#4699C2] text-2xl " /></a> 
     </div>
    ...
    <div className="flex items-center p-2 justify-center flex-col ">
      <div className="flex">
        ...
        <div >
         <p>
          <a href="#author" target="_blank" className="text-sky-400 font-bold">
                 Bruce lee
          </a>
         </p>    
        </div>
     ...
     <h1 className="pb-2  font-bold  ">Read Also:</h1>
      ...
      <div className="max-w-sm rounded overflow-hidden shadow-md  w-[200px] h-[250px] pb-2 mb-4   sm:flex-row md:flex-row  md:justify-center ">
        ...
        <div className="px-4 py-4 w-[225px]">
          ...
          <p className="text-gray-700 text-sm">{ArticleInfo.body1.slice(0,24)}</p>
        </div>
        ...
        <div className="pl-2 flex items-center ">
          ...
          <div className="text-sm">
            <p className=" text-sky-400 font-bold">{ArticleInfo.author.name}</p>
          </div>
        </div>
        </div>
        ...
        <div className="px-4 py-4 w-[225px]">
          ...
          <p className="text-gray-700 text-base text-sm">{ArticleInfo.body1.slice(0,24)}</p>
        </div>
